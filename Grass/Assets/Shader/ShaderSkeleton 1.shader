Shader "Unlit/GrassShader"
{
    Properties
    {
        ...
        SubShader
        {
            ...
            //Code to create a random number
            float rand(float3 co)
            {
                return frac(sin(dot(co.xyz, float3(12.9898, 78.233, 53.539))) * 43758.5453);
            }
            //Creating a rondomness rotation
            ...
            void geo(triangle testvertexOutput IN[3] : SV_POSITION, inout TriangleStream<geometryOutput> triStream)
            {
               ...
               float4 albedo = splat0 * controlColor.r +
                ...
                //making sure the grass geometry only display on the first created textrue on the terrain
                ...
                for (int i = 0; i < BLADE_SEGMENTS; i++)
                {
                    //creating the geo of the grass
                        ...
                        }//Developer can choose if they want detailed grass or more performance and less detaild grass 
                        if (dis < _LowPolyGrassRadius & _LowPolyGrassEnabled < 0.5)
                        {
                            //Low poly in distance creating a extra field for performance and look
                                triStream.Append(GenerateGrassVertex(pos, segmentWidth, segmentHeight, segmentForward, float2(0, t), transformMatrix, grassColor));
                ...
                Pass
            {
                    ...
                    {
                    //Creating underneath the geo grass a display of different textures
                        ...
                        //Connecting the textures with the color display of the terrain
